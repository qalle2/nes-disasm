...
python3 nesdisasm.py --no-zp-abs --no-opcodes 00 test-in/all-instructions.prg > test-out/all-instructions.asm
...
echo "=== Game Genie ==="
python3 nesdisasm.py --no-zp-abs --no-opcodes 00,01,21,31,41,51,61,71,81,a1,c1,d1,e1,f1 --no-access 0800-1fff,2008-3fff,4020-7fff --no-execute 2000-401f --no-write 8002-ffef,fff2-ffff test-in/gamegenie.prg > test-out/gamegenie.asm
...
echo "=== Excitebike (CDL) ==="
python3 nesdisasm.py --no-zp-abs --no-opcodes 00 --no-access 0800-1fff,2008-3fff,4020-bfff --no-execute 2000-401f --no-write 8000-ffff test-in/excitebike.prg -c ~/nes/cdl/excitebike-ju.cdl > test-out/excitebike.asm
...
python3 nesdisasm.py --no-zp-abs --no-opcodes 00,01,41,c1,e1 --no-access 0800-1fff,2008-3fff,4020-bfff --no-execute 2000-401f --no-write 8000-ffff -c ~/nes/cdl/lunarpool-u.cdl test-in/lunarpool.prg > test-out/lunarpool.asm
...
python3 nesdisasm.py --no-zp-abs --no-opcodes 00,01,41,c1,e1 --no-access 0800-1fff,2008-3fff,4020-bfff --no-execute 2000-401f --no-write 8000-ffff -c ~/nes/cdl/lunarpool-u.cdl --unaccessed-as-data test-in/lunarpool.prg > test-out/lunarpool-nounacc.asm
...
python3 nesdisasm.py --no-zp-abs --no-opcodes 00,01,41,c1,e1 --no-access 0800-1fff,2008-3fff,4020-bfff --no-execute 2000-401f --no-write 8000-ffff -i 5 test-in/lunarpool.prg > test-out/lunarpool-nocdl.asm
...
python3 nesdisasm.py --no-zp-abs --no-opcodes 00,01,11,21,31,41,51,61,71,81,a1,c1,d1,e1,f1 --no-access 0800-1fff,2008-3fff,4020-7fff --no-execute 2000-401f --no-write 8000-ffff -c ~/nes/cdl/smb1-w.cdl -i 12 -d 16 test-in/smb1.prg > test-out/smb1.asm
